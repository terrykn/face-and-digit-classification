...
from evaluate import evaluate_model, evaluate_torch_model
...
evaluate_model(Perceptron, X_digit_train, y_digit_train, X_digit_test, y_digit_test, fractions)
evaluate_model(NeuralNet, X_digit_train, y_digit_train, X_digit_test, y_digit_test, fractions)
evaluate_torch_model(TorchNet, X_digit_train, y_digit_train, X_digit_test, y_digit_test, fractions)
...
evaluate_model(Perceptron, X_face_train, y_face_train, X_face_test, y_face_test, fractions)
evaluate_model(NeuralNet, X_face_train, y_face_train, X_face_test, y_face_test, fractions)
evaluate_torch_model(TorchNet, X_face_train, y_face_train, X_face_test, y_face_test, fractions)